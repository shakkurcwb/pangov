...
<div class="container-fluid">
    ...
    <div class="box-typical box-typical-padding">
        ...
        <form name="frm_update" action="{{ url('/events/' . $event->id) }}" method="post">
            @csrf
            @method('patch')
                ...
                <div class="col-sm-10">
                    <div class="form-group input-group">
                        <input type="text"
                            ...
                            name="title" placeholder="" value="{{ old('title') ? old('title') : $event->title }}" required
                        />
                ...
                <div class="col-sm-4">
                    <div class="form-group input-group">
                        <input class="flatpickr flatpickr-input form-control {{ $errors->has('start') ? 'form-control-danger' : '' }}"
                            name="start" value="{{ old('start') ? old('start') : $event->start }}" required
                        />
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group input-group">
                        <input class="flatpickr flatpickr-input form-control {{ $errors->has('end') ? 'form-control-danger' : '' }}"
                            name="end" value="{{ old('end') ? old('end') : $event->end }}" required
                        />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="form-group input-group">
                        ...
                        >{{ old('description') ? old('description') : $event->description }}</textarea>
                        <div class="input-group-append">
                            <span class="input-group-text">
                ...
                <div class="col-sm-4">
                    <div class="form-group input-group">
                        <input type="text"
                            ...
                            name="location" placeholder="" value="{{ old('location') ? old('location') : $event->location }}"
                        />
                        <div class="input-group-append">
                            <span class="input-group-text">
                ...
                <div class="col-sm-4">
                    <div class="form-group input-group">
                        <input type="text"
                            ...
                            name="website" placeholder="" value="{{ old('website') ? old('website') : $event->website }}"
                        />
                        <div class="input-group-append">
                            <span class="input-group-text">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="form-group input-group">
                        ...
                        >{{ old('keywords') ? old('keywords') : $event->keywords }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group input-group">
                        <input type="text"
                            ...
                            name="color" placeholder="" value="{{ old('color') ? old('color') : $event->color }}"
                        />
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group input-group">
                        ...
                        <div class="checkbox-detailed">
                            <input type="radio" name="is_private" id="is_private-1" value="1"
                                {{ old('is_private') == '1' || $event->is_private ? 'checked' : '' }}
                            />
                        ...
                        <div class="checkbox-detailed">
                            <input type="radio" name="is_private" id="is_private-2" value="0"
                                {{ old('is_private') == '0' || !$event->is_private ? 'checked' : '' }}
                            />
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <a href="{{ url('/events') }}" class="btn btn-inline btn-danger"
                        onclick="event.preventDefault(); if (confirm('Deseja realmente excluir este evento? Esta ação não pode ser desfeita!')) document.getElementById('frm-delete').submit();"
                    >Excluir</a>
                </div>
            </div>
        ...
        <form name="frm_delete" id="frm-delete" action="{{ url('/events/' . $event->id) }}" method="post">
            @csrf
            @method('delete')
        </form>
